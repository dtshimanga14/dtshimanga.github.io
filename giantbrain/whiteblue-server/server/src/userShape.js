...
const addressShape = {
	...
	let LngLat = {coords: { 
							accuracy: 6959, altitude: null,altitudeAccuracy: null,
							heading: null,latitude: -4.322099199999999,
							longitude: 15.312486399999997,speed: null
							}, 
						timestamp: 1597181497032 };
export {userShape, assessmentShape,chatShape,postShape, schoolShape,courseShapeTwo,sectionCourse,Paragraph,
		certificatShape,cvShape,promotionShape,v_requester,scheduler,sessionQL,LngLat,
