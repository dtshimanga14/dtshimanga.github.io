		...
		return (<Query query={GET_BOOKSTORES} variables={{ promotionId,id }}>
					{({ data: { libraries,users }, loading }) => {
					  ...
					  return (<div>
								...
								<AddBookModalWindows handlerAddBookModalWindows={this.handlerAddBookModalWindows}/>}
									...
									<div className="booksMarked-rendered">
										{users.books.map(
											...
											<div className="basket-book-frame">
												...
												<a href={newBook.path} tittle={newBook.tittle} target="_blank" className="basket-book-tittle">
													{newBook.tittle}
												</a>
